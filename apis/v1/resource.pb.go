...
type Resource struct {
	...
	// Types that are assignable to TimeSpecifier:
	//
	//	*Resource_PausedAt
	//	*Resource_UnpausedAt
	TimeSpecifier isResource_TimeSpecifier `protobuf_oneof:"time_specifier"`
}
...
func (m *Resource) GetTimeSpecifier() isResource_TimeSpecifier {
	if m != nil {
		return m.TimeSpecifier
	}
	return nil
}

func (x *Resource) GetPausedAt() *timestamppb.Timestamp {
	if x, ok := x.GetTimeSpecifier().(*Resource_PausedAt); ok {
		return x.PausedAt
	}
	return nil
}

func (x *Resource) GetUnpausedAt() *timestamppb.Timestamp {
	if x, ok := x.GetTimeSpecifier().(*Resource_UnpausedAt); ok {
		return x.UnpausedAt
	}
	return nil
}
...
type isResource_TimeSpecifier interface {
	isResource_TimeSpecifier()
}

type Resource_PausedAt struct {
	PausedAt *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=paused_at,json=pausedAt,proto3,oneof"`
}

type Resource_UnpausedAt struct {
	UnpausedAt *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=unpaused_at,json=unpausedAt,proto3,oneof"`
}

func (*Resource_PausedAt) isResource_TimeSpecifier() {}

func (*Resource_UnpausedAt) isResource_TimeSpecifier() {}
...
var file_apis_v1_resource_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x92, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12,
	...
	0x69, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x6d, 0x48, 0x00, 0x52, 0x02, 0x76, 0x6d, 0x12, 0x39,
	...
	,
	...
	,
	...
	,
...
var file_apis_v1_resource_proto_depIdxs = []int32{
	...
	6, // 4: apis.v1.Resource.unpaused_at:type_name -> google.protobuf.Timestamp
	4, // 5: apis.v1.Cluster.node_pools:type_name -> apis.v1.Cluster.NodePool
	5, // 6: apis.v1.Cluster.NodePool.autoscaling:type_name -> apis.v1.Cluster.NodePool.AutoScaling
...
func file_apis_v1_resource_proto_init() {
	...
	file_apis_v1_resource_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Resource_Sql)(nil),
		(*Resource_Vm)(nil),
		(*Resource_PausedAt)(nil),
		(*Resource_UnpausedAt)(nil),
	}
	type x struct{}
